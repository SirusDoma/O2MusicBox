...
namespace FMOD
{
    ...
    */
    ...
    [
        ...
        [REMARKS]
        Note the default reverb properties are the same as the FMOD_PRESET_CXO2ERIC preset.<br>
    ...
    */
    ...
    ie 
    FMOD_REVERB_PROPERTIES prop = FMOD_PRESET_CXO2ERIC;
    ...
    */
    class PRESET
    {
        ...
        public REVERB_PROPERTIES CXO2ERIC()             { return new REVERB_PROPERTIES(0,       0,    1.00f, -1000,  -100,   0,   1.49f,  0.83f, 1.0f,  -2602, 0.007f,   200, 0.011f, 0.25f, 0.000f, 5000.0f, 250.0f, 100.0f, 100.0f, 0x3f );}
    ...
    [
        ...
        Note the default reverb properties are the same as the PRESET_CXO2ERIC preset.
        Note that integer values that typically range from -10,000 to 1000 are represented in 
