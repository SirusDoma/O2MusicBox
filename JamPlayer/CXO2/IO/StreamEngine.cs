...
{
    // ~ Stream Engine Class
    public class StreamEngine : FileStream
    {
        ...
        // ~ Constructor #1
        public StreamEngine(string filename)
        ...
        // ~ Constructor #2
        public StreamEngine(string filename, FileMode mode)
            : base(filename, mode)
        {
            _filename = filename;
            rdr = new BinaryReader(this);
        ...
        // ~ Constructor #3
        public StreamEngine(string filename, FileMode mode, FileAccess access)
