...
namespace Genode.Audio
{
    ...
    public struct SampleInfo
    {
        ...
        public SampleInfo(int sampleCount, int channelCount, int sampleRate)
        {
            ...
            PCM          = SampleCount * channelCount; // uncompressed
        }
        ...
        /// <param name="channelCount">The number of channels.</param>
        /// <param name="sampleRate">The sample rate, in sample per second.</param>
        /// <param name="pcm">The number of pcm of the sound.</param>
        public SampleInfo(int sampleCount, int channelCount, int sampleRate, long pcm)
        {
            SampleCount  = sampleCount;
            ChannelCount = channelCount;
            SampleRate   = sampleRate;
